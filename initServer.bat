...
set PYTHON_PATH=C:\Users\Micro\OneDrive\Documentos\IFSP\2025\Tec\LabProgm\AminoProject\.venv\Scripts\python.exe

REM Caminho do seu app Flask
set FLASK_APP=C:\Users\Micro\OneDrive\Documentos\IFSP\2025\Tec\LabProgm\AminoProject\app.py
